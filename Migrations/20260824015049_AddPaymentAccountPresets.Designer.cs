...
namespace AuditIt.Api.Migrations
{
    ...
    [Migration("20260824015049_AddPaymentAccountPresets")]
    partial class AddPaymentAccountPresets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuditIt.Api.Models.SettlementSetting", b =>
                {
                    ...
                    b.Property<string>("DefaultPaymentAccount")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("PaymentAccountPresetsJson")
                        .HasMaxLength(4000)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AuditIt.Api.Models.ShipmentReminderDispatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RentalId", "RecipientMobile", "Channel", "BusinessDate")
                        .IsUnique();

                    b.ToTable("ShipmentReminderDispatches");
                });

            modelBuilder.Entity("AuditIt.Api.Models.ShipmentReminderSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("AdministratorUserIds")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("VoiceCalledShowNumber")
                        .HasMaxLength(30)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("VoiceSendHour")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(12);

                    b.Property<int>("VoiceSendMinute")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(30);

                    b.Property<string>("VoiceTtsCode")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.ToTable("ShipmentReminderSettings");
                });
