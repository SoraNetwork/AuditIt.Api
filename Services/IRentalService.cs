...
namespace AuditIt.Api.Services
{
    public interface IRentalService
    {
        ...
        Task<RentalOwnerOptionsDto> GetOwnerOptionsAsync();
        ...
        Task<(RentalDto? rental, string? error)> PrepareRentalItemsAsync(Guid rentalId, PrepareRentalItemsDto dto, string? currentUser);
